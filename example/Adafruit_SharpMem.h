...
#define SHARP_DISPLAY_WIDTH 230
#define SHARP_DISPLAY_HEIGHT 303
#define SHARP_BUFFER_WIDTH 232
...
public:
  Adafruit_SharpMem(uint8_t clk, uint8_t mosi, uint8_t cs, uint16_t w = SHARP_DISPLAY_WIDTH,
                    uint16_t h = SHARP_DISPLAY_HEIGHT, uint32_t freq = 2000000);
  Adafruit_SharpMem(SPIClass *theSPI, uint8_t cs, uint16_t w = SHARP_DISPLAY_WIDTH,
                    uint16_t h = SHARP_DISPLAY_HEIGHT, uint32_t freq = 2000000);
  boolean begin();
